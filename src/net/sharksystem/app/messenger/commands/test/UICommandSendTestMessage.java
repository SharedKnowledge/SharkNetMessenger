package net.sharksystem.app.messenger.commands.test;
...
public class UICommandSendTestMessage extends UICommand {
    ...
    @Override
    protected net.sharksystem.ui.messenger.cli.commandarguments.UICommandQuestionnaire specifyCommandStructure() {
